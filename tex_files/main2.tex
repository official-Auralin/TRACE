...
labels TCE with CORP, a Halpern--Pearl \emph{actual-causation} tool---in
Halpern's \emph{modified} variant, with contingencies that reset outputs to
their actual-trace values (verified against the primary sources in the
companion verification suite)---whereas we
...
reproduction of CORP's key; any corpus-scale alignment claim must be stated in
CORP's own (modified) discipline. TempoBench has two tasks: temporal trace evaluation (TTE), asking whether a
